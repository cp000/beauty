                ...
                return {
                    ...
                    template: function(tElement,tAttrs){
                        ...
                        _html += '<nav class="navbar navbar-default navbar-cls-top "role="navigation" style="margin-bottom: 0;width:100%;"> ' +
                            '<div class="navbar-header"> 蓬莱中医院健康管理平台' +
                        ...
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysHospitalUserDTO.sysRoleID == 2 || loginUser.sysHospitalUserDTO.sysRoleID == 3"><a ui-sref="setting"><img src="images/setting01.png">';
                        }
                        _html += '机构设置 </a> </li>';

                        if(tAttrs.title=='active')
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysHospitalUserDTO.sysRoleID == 1 || loginUser.sysHospitalUserDTO.sysRoleID == 2"><a class="active-menu" ui-sref="active"><img src="images/device02.png">';
                        }
                        else
                        {
                            _html += '<li style="display:block;" ng-show="loginUser.sysHospitalUserDTO.sysRoleID == 1 || loginUser.sysHospitalUserDTO.sysRoleID == 2"><a ui-sref="active"><img src="images/device01.png">';
                        }
                        _html += '活动管理 </a> </li>';
                    ...
                    link:function(scope,ele,attrs){
                        ...
                        List.save({},function(data){
                            ...
                            angular.forEach(data.responseData,function(data,index){
                                ...
                                if(data.questionType == 'single' || data.questionType == 'multi' || data.questionName == '年龄' || data.questionName == '性别' || data.questionType == 'select'){
