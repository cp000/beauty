...
import com.meixiang.beauty.modules.healthData.service.DoctorService;
...
//            sysPractitionerUser.setSysHospitalID(UserService.getUser(request).getSysHospitalUserDTO().getId());
            sysPractitionerUser.setSysHospitalID("1");
            sysPractitionerUserDao.insertSysPractitionerUser(sysPractitionerUser);
        }
    }
